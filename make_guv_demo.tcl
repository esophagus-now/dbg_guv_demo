# Call as:
# vivado -mode tcl -nolog -nojournal -source make_guv_demo.tcl -tclargs <out_dir> <part_name> <src_dir>
...
# Create the patched AXI-Stream FIFO
set pname {patched_fifo}
create_ip -name axi_fifo_mm_s -vendor xilinx.com -library ip -version 4.2 -module_name $pname
set_property -dict [list CONFIG.C_USE_TX_CTRL {0} CONFIG.C_USE_RX_CUT_THROUGH {true}] [get_ips $pname]
set xci $pname.xci
...
if {[get_property CORE_CONTAINER [get_files $xci]] != ""} {
    convert_ips [get_files $xci]
}
...
import_files -norecurse ${src_dir}/patched_fifo_wrapper.v
create_bd_cell -type module -reference patched_fifo_wrapper axi_fifo_mm_s_0
...
connect_bd_intf_net [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI]
startgroup
...
connect_bd_net [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn]


# Add in the Verilog files
import_files -norecurse "${src_dir}/collatz_driver.v ${src_dir}/axis_count.v ${src_dir}/collatz.v ${src_dir}/axis_sink.v ${src_dir}/bhand.v"
update_compile_order -fileset sources_1
...
create_bd_cell -type module -reference collatz_driver collatz_driver_0
set_property CONFIG.POLARITY ACTIVE_HIGH [get_bd_pins /collatz_driver_0/rst]
connect_bd_intf_net [get_bd_intf_pins axis_count_0/count] [get_bd_intf_pins collatz_driver_0/count]
create_bd_cell -type module -reference collatz collatz_0
set_property CONFIG.POLARITY ACTIVE_HIGH [get_bd_pins /collatz_0/rst]
connect_bd_intf_net [get_bd_intf_pins collatz_driver_0/num] [get_bd_intf_pins collatz_0/num]
connect_bd_intf_net [get_bd_intf_pins collatz_0/collatz] [get_bd_intf_pins collatz_driver_0/collatz]
create_bd_cell -type module -reference axis_sink axis_sink_0
connect_bd_intf_net [get_bd_intf_pins axis_sink_0/sink] [get_bd_intf_pins collatz_driver_0/sink]
connect_bd_net [get_bd_pins axis_sink_0/clk] [get_bd_pins collatz_0/clk]
connect_bd_net [get_bd_pins collatz_0/clk] [get_bd_pins collatz_driver_0/clk]
connect_bd_net [get_bd_pins collatz_driver_0/clk] [get_bd_pins axis_count_0/clk]
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins collatz_driver_0/rst]
